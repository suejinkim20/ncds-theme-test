...
class PMPro_Approvals {
 ...
 style="display: none;"<?php } ?>>
	...
	public static function pmpro_confirmation_message( $confirmation_message ) {
		...
		$confirmation_message .= '<p>'.sprintf( __( 'Thank you for your membership to %1$s. You will be notified once we have processed your paperwork.', 'pmpro-approvals' ), get_bloginfo( 'name' ), $current_user->membership_level->name, $approval_status ) .'</p>';

		$confirmation_message .= '<p>' . sprintf( __( 'Below are details about your membership account.', 'pmpro-approvals' ), $current_user->user_email ) . '</p>';
