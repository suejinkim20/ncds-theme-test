...
?>
<link rel="stylesheet" href="<?php echo site_url(); ?>/wp-content/plugins/smartcat_our_team/assets/css/single.css">
...
<?php 
$t_id = get_the_ID();
$t_term = get_the_terms( $t_id, 'team_member_position' );
?>
            ...
            <div id="sc_team_sidebar_staff_list">
                ...
                <ul class="sc_team_list">
                    ...
                    <?php foreach( $all_terms as $term ) : ?>
                        ...
                        <?php if ($t_term[0]->name == $term->name): ?>
                            
                            <li class="sc_team_group"></li>
